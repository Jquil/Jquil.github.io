在之前'[使用B+Tree提高查询效率](https://jquil.github.io/#/show?type=note&id=181)'一节中我们了解BTree以及B+Tree的思想，想象一下我们的数据以B+Tree这种数据结构的形式存储在硬盘上，当我们需要查询某条数据的时候，因为它磁盘io次数少，所以它查询效率是很高效的；
...
![](https://jquil.github.io/file/markdown/note/183/img/Snipaste_2023-06-20_16-49-59.png)
</div>
...
![](https://jquil.github.io/file/markdown/note/183/img/Snipaste_2023-06-20_17-22-53.png)
</div>
...
![](https://jquil.github.io/file/markdown/note/183/img/GIF-2023-6-20-17-27-08.gif)
</div>
